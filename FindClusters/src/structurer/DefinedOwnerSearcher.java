...
public class DefinedOwnerSearcher extends OwnerSearcher {

	public DefinedOwnerSearcher(boolean printScore) {
		super(printScore);
	}
			...
			while ((strLine = br.readLine()) != null) 
			{
				...
				if (program.getName().equals(output[0])) {
					...
					if (definedModule != null) {
						SignalScore (Constants.SCORETMP_DEFINEDOWNER, "FIT=Y,SEL=N", definedModule.getType(), definedModule.getName(), program );							
					}
